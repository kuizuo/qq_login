...
function initCaptcha() {
  (window as any).capInit('', {
    type: 'popup',
    callback: (t) => {
      if (t.ret === 0) {
        emit('success', {
          randstr: t.randstr, ticket: t.ticket,
        })
      }
    },
    showHeader: false,
...
<template>
  <n-modal>
    <div id="cap_iframe" style="width: 230px; height: 220px;" />
  </n-modal>
</template>
